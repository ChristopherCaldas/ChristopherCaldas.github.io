...
function findSum() {
  ...
  document.getElementById("num11").value = Math.round(catalyst*10)/10;
  document.getElementById("num12").value = Math.round(plantfixedcosts*10)/10;
  document.getElementById("sum").value = Math.round(transport*10)/10;
}
